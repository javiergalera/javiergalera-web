  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Javier, an iOS Software Developer and entrepeneur based in Spain. I’m the founder and CEO of Space, where we forge technologies with the goal of making a better world."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            iOS Software Engineer, Entrepreneur, and Space Enthusiast.
          </h1>
