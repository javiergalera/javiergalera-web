...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700">
      ...
      <Button href="/downloads/resume.pdf" target="_blank" variant="secondary" className="group mt-6 w-full">
        Download CV
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Javier, an iOS Software Developer based in Spain."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m an iOS Software Developer based in Spain.
          </p>
